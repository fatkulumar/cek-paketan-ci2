<?php
    ...
    class M_paket extends CI_Model{
        ...
        function list_nama_paket() {
            return $this->db
            ->select('`id_paket`, `id_santri`, `nama_paket`, `penerima`, `jenis_kirim`, `tgl_terima`, `tgl_ambil`, `pengambil`, `status_ambil`, `hp`, `creat_at`, `modified_at`, `tahun`, `jml_paket`, count(nama_paket) as jumlah')
