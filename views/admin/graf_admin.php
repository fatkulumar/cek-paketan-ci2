...
<div class="row content">
    ...
    <div class="col-lg-6 pt-4 pt-lg-0 mt-5 mb-4" data-aos="fade-left" data-aos-delay="200">
        <!-- grafik peringkat -->
        <ul>
            <div class="mb-5" id="peringkat" style="background-color: white; padding-top: 5em; min-width: 310px; height: 400px; margin: 0 auto"></div>
        </ul>
        <ul>
            <!-- total pemaket -->
            <div class="mb-5" id="total_pemaket" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
        </ul>
        <ul>
...
if(tahun == ""){
    ...
    $.getJSON(link, function(data) {
        ...
        // }
        var jml_nm = data.jumlah_nama_paket
        var total_nm = data.total_nama.length
       ...
       Highcharts.chart('nama_paketan', {
        ...
        Highcharts.chart('jenis_kirim', {
            ...
            series: [
                {
            name: 'Langsung',
            data: [<?= json_encode($hitungLangsung) ?>, [<?= json_encode($hitungCod) ?>]],
            stack: 'male'
            }, 
            {
            name: 'COD',
            data: [<?= json_encode($hitungCod) ?>],
            stack: 'male'
            },
        ...
        //grafik total pemaket
        Highcharts.chart('total_pemaket', {
            ...
            //     {
            // name: 'Langsung',
            // data: [<?= json_encode($hitungLangsung) ?>],
            // stack: 'male'
            // }, 
            {
            name: 'Total',
