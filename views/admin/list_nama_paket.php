...
<script src="<?= base_url('assets/cekmobile.js') ?>"></script>
  ...
  <main id="hero">
        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                ...
                <?php
                    ...
                    $arr_a = implode(" ",$jumlah);
                    $arr_a;
                ?>
 
                    <div class="table table-responsive">   
                      <!-- /.content-header -->
                        <table id="table_list_nama_paket" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Kode</th>
    ...
    <div class="modal-dialog" role="document">
        ...
        <script>
            var table_list_nama_paket = $('#table_list_nama_paket').DataTable(
        {
        "processing": true, 
            "serverSide": true, 
            ...
            "ajax": {
                "url": site_url = "http://"+ window.location.host +"/cek-paketan-ci/Admin/ajax_list_nama_paket",
                "type": "POST"
            },
            //Set column
            // "columnDefs": [
        ...
        var save = $('#savePengambil').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    $("#pengambil").val("")
                    table_list_nama_paket.ajax.reload(null, false);
                }
            })
        //pemanggilan function untuk table paket bukan detail
            tampilPaketBukanDetail()
